export default function DMCAPolicy() {
  return (
    <div className="min-h-screen bg-slate-50 px-4 sm:px-6 lg:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="p-8 pl-3">
          <h1 className="text-3xl font-bold text-teal-800 mb-6">DMCA Policy</h1>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              We will respond to clear notices of alleged copyright infringement that comply with the
              Digital Millennium Copyright Act.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              If you believe that content on our platform infringes your copyright, please provide our
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 leading-relaxed">
              We will terminate the accounts of users who are repeat infringers of intellectual
              property rights.
            </p>
          </section>
        </div>
